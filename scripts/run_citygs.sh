...
TEST_PATH="data/mill19/rubble-pixsfm/val/input"

COARSE_CONFIG="rubble_coarse"
CONFIG="rubble_c9_r4"

out_name="rubble"  # 4 denotes resolution
max_block_id=8
port=4041

# # train coarse global gaussian model
# CUDA_VISIBLE_DEVICES=$(get_available_gpu) python train_large.py --config config/$COARSE_CONFIG.yaml
